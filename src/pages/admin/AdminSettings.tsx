        ...
        <div className="tab-panel">
          <div className="settings-grid">
            <div className="settings-field">
              ...
              <input id="full-name" className="input-field" defaultValue="Admin User" />
            </div>
            <div className="settings-field">
              <label htmlFor="email">Email Address</label>
              <input id="email" className="input-field" defaultValue="admin@example.com" />
            </div>
            <div className="settings-field">
              <label htmlFor="department">Department</label>
              <input id="department" className="input-field" defaultValue="Administration" />
            </div>
          </div>
          <div className="settings-grid">
            <div className="settings-field">
